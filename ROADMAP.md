...
- Keep `scripts/remote_demo_acceptance_pack.py` as the safe two-machine `remote_demo_acceptance_v1` artifact that waits for a real remote `model_bundle_infer` result and collects `remote_compute_evidence_v1` plus `support_bundle`.
