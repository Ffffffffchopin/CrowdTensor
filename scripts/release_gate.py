...
def check_security_docs(root: Path) -> dict[str, Any]:
    ...
    for fragment in [
        ...
        "install_operator.sh",
        "operator_quickstart.sh",
        ".crowdtensor-operator-venv",
        "CROWDTENSOR_OPERATOR_VENV",
        "CROWDTENSOR_QUICKSTART_WAIT_SECONDS",
        "CROWDTENSOR_QUICKSTART_SKIP_INSTALL",
        "control_plane.pid",
        "control_plane.log",
        ...
        "start_tunnel.sh",
        "tunnel_doctor.sh",
        "crowdtensor swarm-tunnel-doctor",
        "crowdtensor_swarm_tunnel_doctor_v1",
        ...
        "verify_bootstrap.sh",
        "handoff_doctor.sh",
        "ready_for_handoff.sh",
        "ready_for_handoff_script_ready",
        "one_command_handoff_check",
        "manual_launchers.operator_quickstart",
        "operator_status.sh",
        "operator_status_script_ready",
        "crowdtensor coordinator-route",
        "crowdtensor_coordinator_route_cli_v1",
        "coordinator_route.json",
        "coordinator_route.md",
        "join_options",
        "recommended_join_option",
        ...
        "stage0.run-miner.sh",
        "--quickstart",
        "CrowdTensor Miner quickstart",
        "CROWDTENSOR_MINER_QUICKSTART_SKIP_INSTALL",
        "--doctor",
        "--setup",
        "--start",
