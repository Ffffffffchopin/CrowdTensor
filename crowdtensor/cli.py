...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    infer = subparsers.add_parser(
        ...
        description=(
            ...
            "are local-private, whether saved artifacts use placeholders, and raw_prompt_public=false;\n"
            "prompt_scope never stores raw prompt text.\n\n"
            ...
            "was shown locally but removed from JSON/Markdown.\n\n"
