...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    infer = subparsers.add_parser(
        ...
        description=(
            ...
            "GPU evidence was referenced; fresh_kaggle_gpu=True is the only claim that a fresh\n"
            "Kaggle GPU proof was verified by the source report. The adjacent evidence_scope_note\n"
            "line is the human-readable explanation of that scope.\n"
    ...
    generate = subparsers.add_parser(
        ...
        description=(
            ...
            "claim that a fresh Kaggle GPU proof was verified. The adjacent evidence_scope_note\n"
            "line is the human-readable explanation of that scope.\n"
