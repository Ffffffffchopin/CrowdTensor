...
class P2PSwarmInferenceV06PackTests(unittest.TestCase):
    ...
    def test_check_builds_ready_evidence_import(self) -> None:
        ...
        self.assertEqual(report["user_status"]["recommended_label"], "inspect P2P v0.6 evidence")
        self.assertEqual(report["review_summary"]["schema"], "p2p_swarm_inference_v06_review_summary_v1")
        self.assertEqual(report["review_summary"]["next_step"], "review_artifacts")
        self.assertEqual(report["recommended_next_command"]["label"], "inspect P2P v0.6 evidence")
        ...
        self.assertIn("- recommended: `inspect P2P v0.6 evidence` reason=`review_artifacts`", markdown)
        ...
        self.assertIn("- present: `3` / `3`", markdown)
        ...
        self.assertEqual(support["review_summary"]["schema"], "p2p_swarm_inference_v06_review_summary_v1")
        self.assertEqual(support["recommended_next_command"]["label"], "inspect P2P v0.6 evidence")
