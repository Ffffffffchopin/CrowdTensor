...
CHECK_PATH = Path(__file__).resolve().parents[1] / "scripts" / "colab_tpu_reacquire_retry_check.py"
spec = importlib.util.spec_from_file_location("colab_tpu_reacquire_retry_check", CHECK_PATH)
...
def valid_success_report():
    return {
        ...
        "ok": True,
        "colab_tpu_reacquire_ready": True,
        ...
        "successful_report_path": "dist/example/attempt-02-v5e1/colab_tpu_session_probe.json",
        "accelerator": "V5E1",
        ...
        "attempts": [
            {
                ...
                "runtime_proxy_url_public": False,
                "endpoint_public": False,
                "report_path": "dist/example/attempt-01-v5e1/colab_tpu_session_probe.json",
            ...
            },
            {
                ...
                "runtime_proxy_url_public": False,
                "endpoint_public": False,
                "report_path": "dist/example/attempt-02-v5e1/colab_tpu_session_probe.json",
            },
        ],
    }
...
def test_failure_report_fails_with_require_ready():
    ...
    assert "Colab TPU reacquire was not verified" in errors
