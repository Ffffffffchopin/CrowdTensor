...
class PublicP2PSwarmInferenceV1RCPackTests(unittest.TestCase):
    ...
    def test_check_builds_ready_evidence_import(self) -> None:
        ...
        self.assertEqual(report["review_summary"]["schema"], "public_p2p_swarm_inference_v1_rc_review_summary_v1")
        ...
        self.assertEqual(report["artifact_summary"]["schema"], "public_p2p_swarm_inference_v1_rc_artifact_summary_v1")
        self.assertTrue(report["artifact_summary"]["inspect_first"].endswith("public_p2p_swarm_inference_v1_rc.md"))
        self.assertTrue(report["artifact_summary"]["summary_json"].endswith("public_p2p_swarm_inference_v1_rc.json"))
    ...
    def test_package_mode_writes_signed_runbook(self) -> None:
        ...
        self.assertTrue(report["ok"], report)
        self.assertFalse(report["rc"]["ready"])
        self.assertIn("public_p2p_v1_rc_runbook_ready", report["diagnosis_codes"])
        self.assertIn("public_p2p_v1_rc_package_ready", report["diagnosis_codes"])
        self.assertNotIn("public_p2p_swarm_inference_v1_rc_ready", report["diagnosis_codes"])
        ...
        self.assertEqual(report["recommended_next_command"]["reason"], "verify_signed_local_p2p_path")
        self.assertIn("public-p2p-v1-rc local-smoke", report["recommended_next_command"]["command_line"])
        self.assertTrue(report["artifact_summary"]["public_artifact_safe"])
        self.assertGreaterEqual(report["artifact_summary"]["present_artifact_count"], 3)
