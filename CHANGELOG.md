...
- Demo Manifest tooling (`scripts/demo_manifest_pack.py`, `scripts/demo_manifest_check.py`) with `demo_manifest_v1`, the local-loopback latest output artifact that indexes `runtime_matrix.json`, `remote_compute_evidence_v1`, `support_bundle`, and `remote_compute_observability_v1` summaries.
